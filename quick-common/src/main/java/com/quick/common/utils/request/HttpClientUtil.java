...
public class HttpClientUtil {
    ...
    private static String sendHttpPost(HttpPost httpPost) {
        ...
        try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
            ...
            log.error("sendHttpPost " + e.getMessage());
    ...
    private static String sendHttpGet(HttpGet httpGet) {
        ...
        try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
            ...
            log.error("sendHttpGet " + e.getMessage());
            throw new RuntimeException(e);
        }
        return responseContent;
    }
    ...
    private static String sendHttpPut(HttpPut httpPut) {
        ...
        try (CloseableHttpResponse response = httpClient.execute(httpPut)) {
            ...
            log.error("sendHttpPut " + e.getMessage());
            throw new RuntimeException(e);
        }
        return responseContent;
    }
    ...
    private static String sendHttp(HttpRequestBase httpRequestBase) {
        ...
        try (CloseableHttpResponse response = httpClient.execute(httpRequestBase)) {
            ...
            log.error("sendHttp " + e.getMessage());
            throw new RuntimeException(e);
        }
        return responseContent;
    }
